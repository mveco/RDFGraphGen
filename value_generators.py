...
values_dict = {'streetAddress' : get_array_from_csv('namespaces//street_name.txt'),'firstName' : get_array_from_csv('namespaces//female_first_name.csv') + get_array_from_csv('namespaces//male_first_name.csv')}
...
def generate_date(min_exclusive, min_inclusive, max_exclusive, max_inclusive,
    ...
    if not max_inclusive:
        max_inclusive = min_inclusive + 3000000000
...
def get_predefined_value(sh_path):
    ...
    elif prop == 'name' or prop == 'givenName':
